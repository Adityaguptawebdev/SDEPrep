# SDE Prep — Interview Notes

Personal interview-prep notes, built topic by topic while preparing.
...
DSA/                          Data Structures & Algorithms — 29-topic syllabus (basics → advanced) + 20 patterns
interview-questions/
...
- [x] [DSA](DSA/README.md) — 29-topic syllabus (Arrays → Trees → Recursion → Graphs → DP → Segment Tree) with diagrams, code & LeetCode practice, plus 20 patterns, done
