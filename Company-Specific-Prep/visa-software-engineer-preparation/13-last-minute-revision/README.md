# 13 — Questions That Keep Repeating (evidence-ranked)

> Counts come from the collected reports ([research-findings](../01-hiring-process/research-findings.md)). **HIGH** = 3+ independent reports · **MEDIUM** = 2 · **ONE-OFF** = 1. Nothing here is "always asked" — *Visa's process varies by team, requisition and hiring cycle.*

**Easy analogy — pichhle 5 saal ke board papers**: Jo sawaal baar-baar aaye, woh pehle pakke karo; one-offs sirf padh lo.

## HIGH-FREQUENCY (3+ reports)

| Area | Question / topic | Reports | Revise |
|---|---|---|---|
| Round format | CodeSignal OA: 4 questions, ~70 min, /600 | 15+ | [OA](../02-online-assessment/README.md) |
| Round format | Resume / project deep-dive in every round | almost all | [Project](../10-project-deep-dive/README.md) |
| OA | Bus departure / next shuttle with `"HH:MM"` | 4 | [S1](../02-online-assessment/01-oa-arrays-strings-hashmap.md#s1-bus-departures-in-hhmm--easy--high--reported) |
| OA | Min difference between values ≥ x apart (LC 2817) | 3 | [B1](../02-online-assessment/02-oa-stack-queue-search-sorting-heap.md#b1-minimum-difference-between-values-at-least-x-apart--medium--high--reported--leetcode-2817) |
| OA | Text justification / newspaper variants | 3 | [S6](../02-online-assessment/01-oa-arrays-strings-hashmap.md#s6-newspaper--text-justification-with-a--border--medium-implementation--high--reconstructed) |
| OA topics | Arrays (21 reports), strings (17), simulation (16), HashMap (12), matrix (10) | — | [OA ranking](../02-online-assessment/README.md#2-top-visa-oa-patterns-to-master-ranked-only-by-frequency) |
| DSA | K-th largest / second largest without sorting | 5 | [DSA 4 §3](../03-dsa/04-linked-list-stack-heap-sorting.md#3-k-th-largest--second-largest-without-sorting) |
| DSA | Linked-list set (merge, cycle, intersection, reverse) | 6 (mostly senior) | [DSA 4 §1](../03-dsa/04-linked-list-stack-heap-sorting.md#1-linked-list-set) |
| DSA | House Robber → circular | 3 | [DSA 7 §1](../03-dsa/07-dynamic-programming.md#1-house-robber--house-robber-ii-circular) |
| DSA | Binary search on the answer (Aggressive Cows, Book Allocation, trips) | 3 | [DSA 3](../03-dsa/03-binary-search.md) |
| DSA | Level-order traversal (+ zigzag) | 3 | [DSA 5 §1](../03-dsa/05-trees.md#1-level-order-traversal--zigzag) |
| DSA | Longest Substring Without Repeating Characters | 3 | [DSA 2 §2](../03-dsa/02-sliding-window-and-rate-limiter.md#2-longest-substring-without-repeating-characters) |
| DSA | BFS on grid / implicit graph (Islands, Word Ladder) | 3 | [DSA 6](../03-dsa/06-graphs-and-matrix.md) |
| Java | HashMap internals + equals/hashCode | 6 | [Java 2](../04-java/02-collections-hashmap-internals.md) |
| Java | OOP pillars with real examples | 5 | [Java 1 §1](../04-java/01-oop-and-class-design.md#1-the-4-pillars--with-real-examples-high) |
| Java | Interface vs abstract class · default methods · diamond | 5 | [Java 1 §5](../04-java/01-oop-and-class-design.md#5-interface-vs-abstract-class-default-methods-diamond-problem-high) |
| Java | Overloading vs overriding · Singleton · streams · array vs linked list | 3 each | [Java README](../04-java/README.md) |
...
## ONE-OFF (interesting but isolated)
